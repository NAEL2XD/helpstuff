...
# Don't touch stuff unless you know what you are doing!!!!!!!!
...
#---------------------------------------------------------------------------------
APP_TITLE       := Haxe3DS
APP_DESCRIPTION := Made with <3 using Haxe!
APP_AUTHOR      := Author
...
CFLAGS      := $(COMMON) -std=c++17 -Wno-unused-variable
CXXFLAGS    := $(CFLAGS) -w
ASFLAGS     := $(ARCH)
...
#---------------------------------------------------------------------------------
.PHONY : clean all bootstrap 3dsx cia elf 3ds release
...
# main targets
#---------------------------------------------------------------------------------
.PHONY: all 3dsx cia elf 3ds release
